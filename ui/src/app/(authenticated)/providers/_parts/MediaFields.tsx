    ...
    <>
      ...
      {dialogCategory === "tts" && (
        <div className="space-y-1.5">
          ...
          <p className="text-[11px] text-muted-foreground/60">{t("providers.field_voice_hint")}</p>
        </div>
      )}
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-[11px] text-muted-foreground/60">{t("providers.field_api_key_vault_hint")}</p>
      </div>
