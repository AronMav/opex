...
mod tests {
    ...
    async fn all_non_text_variants_use_blocking_path_via_send_async() {
        ...
        let cases = vec![
            ...
            StreamEvent::MessageStart { message_id: opex_types::ids::MessageId::from(uuid::Uuid::nil()) },
            StreamEvent::StepStart {
                iteration: opex_types::ids::IterationId {
                    index: 0,
                    message_id: opex_types::ids::MessageId::from(uuid::Uuid::nil()),
                },
            },
            StreamEvent::ToolCallStart {
                id: opex_types::ids::ToolCallId::from("t1"),
                name: "tool".into(),
            ...
            StreamEvent::ApprovalResolved {
                approval_id: opex_types::ids::ApprovalId::from(uuid::Uuid::nil()),
                action: opex_types::approvals::ApprovalAction::Approved,
                modified_input: None,
            },
