...
- [x] **CACHE-02**: CLAUDE.md системного агента участвует в cache_control как отдельная 3-я breakpoint (после system prompt и tool definitions)
